  ...
  const getRecommendations = (severity: string, score: number) => {
    switch (severity) {
      ...
      case "mild":
        return {
          message:
            "Your responses suggest minimal to mild anxiety symptoms. This is encouraging, but continue to prioritize your mental wellness.",
          nextSteps: [
            "Explore our relaxation techniques and guided meditation resources",
            "Practice stress management and mindfulness exercises",
            "Maintain healthy lifestyle habits and regular sleep patterns",
          ],
          resources: "/resources",
        }
      case "moderate":
        return {
          message:
            "Your responses indicate moderate anxiety symptoms. We recommend speaking with a mental health professional for personalized support.",
          nextSteps: [
            "Book a confidential session with our college counsellor",
            "Learn anxiety management techniques through our resources",
            "Consider joining our peer support groups for additional help",
          ],
      ...
      case "severe":
        return {
          message:
            "Your responses suggest significant anxiety symptoms that warrant immediate professional attention. Please reach out for support right away.",
          nextSteps: [
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 py-20">
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              <Badge variant="secondary">GAD-7 Assessment Complete</Badge>
              <h1 className="text-4xl font-bold">Your Results</h1>
            </div>

            <Card className="bg-card/80 backdrop-blur-sm border-border/50">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl">Anxiety Screening Results</CardTitle>
                <CardDescription>Based on your responses over the past 2 weeks</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="text-center space-y-2">
                  <div className="text-4xl font-bold">{totalScore}/21</div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <Link href="/assessment/phq9" className="flex-1">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <Badge variant="secondary">GAD-7 Anxiety Screening</Badge>
          ...
          <Card className="bg-card/80 backdrop-blur-sm border-border/50">
            <CardHeader>
              <CardTitle className="text-xl text-center">{gad7Questions[currentQuestion]}</CardTitle>
            </CardHeader>
